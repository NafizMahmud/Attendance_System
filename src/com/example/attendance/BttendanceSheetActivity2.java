...
public class BttendanceSheetActivity2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    id1.setText(batch_name+""+dept_code+""+"061");
	    id2.setText(batch_name+""+dept_code+""+"062");
	    id3.setText(batch_name+""+dept_code+""+"063");
	    id4.setText(batch_name+""+dept_code+""+"064");
	    id5.setText(batch_name+""+dept_code+""+"065");
	    id6.setText(batch_name+""+dept_code+""+"066");
	    id7.setText(batch_name+""+dept_code+""+"067");
	    id8.setText(batch_name+""+dept_code+""+"068");
	    id9.setText(batch_name+""+dept_code+""+"069");
	   id10.setText(batch_name+""+dept_code+""+"070");
	   ...
	   pid1.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View arg0) {
			...
			SharedPreferences sharedpref = getSharedPreferences( "lecture1", Context.MODE_PRIVATE);
		    SharedPreferences.Editor editor = sharedpref.edit();
		    editor.putString("061", "Present");			
		    editor.apply();
		}
	});
