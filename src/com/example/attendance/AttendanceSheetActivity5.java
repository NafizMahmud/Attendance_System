...
public class AttendanceSheetActivity5 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
	   ...
	   pid1.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View arg0) {
			...
			SharedPreferences sharedpref = getSharedPreferences( "lecture5", Context.MODE_PRIVATE);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.attendance_sheet
				, menu);
		return true;
	}
}
